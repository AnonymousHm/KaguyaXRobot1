...
<p align="center">
    ...
    <a href="https://github.com/AnonymousHm">
        <img src="http://ForTheBadge.com/images/badges/built-with-love.svg" alt="built-with-love">
    </a> 
</p>
<h1 align="center">
Special Thanks To <a href="https://GitHub.com/TheHamkerCat">TheHamkerCat</a>
</h1>
<h3 align="center"> 
    Ready to use method
</h3>
...
```console
anonymoushm@arch:~$ python3 -m wbb
```
<h1>
    <p align="center">
...
```console
anonymoushm@arch:~$ git clone https://github.com/AnonymousHm/KaguyaXRobot
anonymoushm@arch:~$ cd KaguyaXRobot
anonymoushm@arch:~$ pip3 install pyrogram TgCrypto
anonymoushm@arch:~$ python3 str_gen.py
```
...
anonymoushm@arch:~$ git clone https://github.com/AnonymousHm/KaguyaXRobot
anonymoushm@arch:~$ cd KaguyaXRobot
anonymoushm@arch:~$ cp sample_config.env config.env
```
...
```console
anonymoushm@arch:~$ sudo docker build . -t wbb
anonymoushm@arch:~$ sudo docker run wbb
```
